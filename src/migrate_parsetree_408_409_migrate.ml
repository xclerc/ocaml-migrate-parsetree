...
and copy_out_type_decl :
  ...
  fun
    ...
    ->
    {
      ...
      Ast_409.Outcometree.otype_immediate = copy_otype_immediate otype_immediate;
...
and copy_otype_immediate : Ast_408.Outcometree.out_immediacy -> Ast_409.Outcometree.out_immediacy = function
  | Ast_408.Outcometree.Unknown -> Ast_409.Outcometree.Unknown
  | Ast_408.Outcometree.Always -> Ast_409.Outcometree.Always
  | Ast_408.Outcometree.Always_on_64bits-> Ast_409.Outcometree.Always_on_64bits
